...
public final class PackerNg {
    ...
    public static final class MarketInfo {
        ...
        MarketInfo(final String market, final Exception error) {
            this.market = market;
            this.error = error;
        }
    ...
    private static class MarketExistsException extends IOException {
        ...
        MarketExistsException(final String message) {
            super(message);
        }
    }
    ...
    private static class MarketNotFoundException extends IOException {
        ...
        MarketNotFoundException(final String message) {
            super(message);
        }
    }
    ...
    public static class Helper {
        ...
        private static void writeZipComment(File file, String comment) throws IOException {
            ...
            byte[] data = comment.getBytes(StandardCharsets.UTF_8);
            ...
            try (RandomAccessFile raf = new RandomAccessFile(file, "r")) {
                ...
                if (isMagicMatched(buffer)) {
                    ...
                    if (length > 0) {
                        ...
                        return new String(bytesComment, StandardCharsets.UTF_8);
                    } else {
        ...
        private static void writeMarket(final File file, final String market) throws IOException {
            writeZipComment(file, market);
        }

        private static String readMarket(final File file) throws IOException {
            return readZipComment(file);
        }

        private static boolean verifyMarket(final File file, final String market) throws IOException {
        ...
        private static List<String> parseMarkets(final File file) throws IOException {
        ...
        private static void copyFile(File src, File dest) throws IOException {
            ...
            try (FileChannel source = new FileInputStream(src).getChannel(); FileChannel destination = new FileOutputStream(dest)
                    .getChannel()) {
