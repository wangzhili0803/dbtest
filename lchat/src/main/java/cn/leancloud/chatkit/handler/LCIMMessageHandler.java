...
/**
 * Created by zhangxiaobo on 15/4/20. AVIMTypedMessage 的 handler，socket 过来的 AVIMTypedMessage 都会通过此 handler 与应用交互 需要应用主动调用
 * AVIMMessageManager.registerMessageHandler 来注册 当然，自定义的消息也可以通过这种方式来处理
 */
public class LCIMMessageHandler extends AVIMTypedMessageHandler<AVIMTypedMessage> {
    ...
    /**
     * 点击 notification 触发的 Intent 注意要设置 package 已经 Category，避免多 app 同时引用 lib 造成消息干扰
     */
