...
/**
 * Created by wli on 16/3/8. 会话 item，包含三个属性，ConversatoinId，unreadCount，updateTime
 */
class LCIMConversationItem implements Comparable<LCIMConversationItem> {
    ...
    @Override
    public int compareTo(LCIMConversationItem another) {
        return (int) (another.updateTime - updateTime);
    }
}